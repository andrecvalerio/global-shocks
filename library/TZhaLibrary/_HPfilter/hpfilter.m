function [s,sdev,desvabs] = hpfilter(y,w,plotter)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   Colombia
%
%   TZ: Smooth parameter w = 129600 for monthly, 1600 for quarterly, and 6.25 for annual data.
%
...
%
%   sdev = y-s (deviations from the trend).  Added by T. Zha
%
%   [s] = hpfilter(y,w)
