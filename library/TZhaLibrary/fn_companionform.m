...
%    Column corresponds to equations with
...
% lags: number of lags.
%-------
% BhatCom: nvar*lags X nvar*lags companion matrix BhatC to strack the VAR(p) to the VAR(1) with z_t = C_Com + BhatC z_{t-1}.
%        Row corresponds to equations.
