...
%        rl: innovationl parameter
%            rl: 0x0 ---> rl=[0.5 0.06 0.99] (e.g. rl=[])
%            rl: 1x1 ---> fixed value of rho parameter
%            rl: 1x3 ---> [r_min dr  r_max] search is performed
%                on this range, using dr as step.
% ------------------------------------------------------------
...
if (nrl == 1)
   rho = rl;
   type = 4; %Fixed innovational parameter
else 
