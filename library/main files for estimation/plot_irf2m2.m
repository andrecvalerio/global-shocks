...
name_shock  = varlist(which_shock);  %PCOM
...
%%%%%%%%%%% Ploting the first shock - PCOM shock
zero=0*(1:imstp);
...
% saving the figures
if which_country == 1       % saving for Brazil
    saveas(gcf,'irf_cr_br_m2','jpg');
elseif which_country == 2   %saving for Chile
    saveas(gcf,'irf_cr_ch_m2','jpg');
elseif which_country == 3   %saving for Colombia
    saveas(gcf,'irf_cr_col_m2','jpg');
elseif which_country == 5   %saving for Mexico
    saveas(gcf,'irf_cr_mex_m2','jpg');
elseif which_country == 4   %saving for Peru
    saveas(gcf,'irf_cr_per_m2','jpg');
end
