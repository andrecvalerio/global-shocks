...
%
indxGforehat = 0;  % 1: plot unconditoinal forecasts; 0: no such plot
rnum = nvar/2;      % number of rows in the graph
cnum = nvar/2;      % number of columns in the graph
if rnum*cnum<nvar
...
if indxEstima
   ...
   nn = [nvar lags imstp];
   imfhat = fn_impulse(Bhat,swish,nn);    % Imp.Respon.Functions in the form that is congenial to RATS.
