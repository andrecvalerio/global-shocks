...
% saving the figures
if which_country == 1       % saving for Brazil
    saveas(gcf,'irf_vix_br_m7','jpg');
elseif which_country == 2   %saving for Chile
    saveas(gcf,'irf_vix_ch_m7','jpg');
elseif which_country == 3   %saving for Colombia
    saveas(gcf,'irf_vix_col_m7','jpg');
elseif which_country == 5   %saving for Mexico
    saveas(gcf,'irf_vix_mex_m7','jpg');
elseif which_country == 4   %saving for Peru
    saveas(gcf,'irf_vix_per_m7','jpg');
end
...
% saving the figures
if which_country == 1       % saving for Brazil
    saveas(gcf,'irf_cr_br_m7','jpg');
elseif which_country == 2   %saving for Chile
    saveas(gcf,'irf_cr_ch_m7','jpg');
elseif which_country == 3   %saving for Colombia
    saveas(gcf,'irf_cr_col_m7','jpg');
elseif which_country == 5   %saving for Mexico
    saveas(gcf,'irf_cr_mex_m7','jpg');
elseif which_country == 4   %saving for Peru
    saveas(gcf,'irf_cr_per_m7','jpg');
end
