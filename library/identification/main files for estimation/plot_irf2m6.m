...
% State each shock separatedely, first vix, then PCOM, VIX
...
%%%%%%%%%%%% Obtaining the IRFs for the first shock - vix shock
...
% saving the figures
if which_country == 1       % saving for Brazil
    saveas(gcf,'irf_pcom_br_m6','jpg');
elseif which_country == 2   %saving for Chile
    saveas(gcf,'irf_pcom_ch_m6','jpg');
elseif which_country == 3   %saving for Colombia
    saveas(gcf,'irf_pcom_col_m6','jpg');
elseif which_country == 5   %saving for Mexico
    saveas(gcf,'irf_pcom_mex_m6','jpg');
elseif which_country == 4   %saving for Peru
    saveas(gcf,'irf_pcom_per_m6','jpg');
end
...
% saving the figures
if which_country == 1       % saving for Brazil
    saveas(gcf,'irf_cr_br_m6','jpg');
elseif which_country == 2   %saving for Chile
    saveas(gcf,'irf_cr_ch_m6','jpg');
elseif which_country == 3   %saving for Colombia
    saveas(gcf,'irf_cr_col_m6','jpg');
elseif which_country == 5   %saving for Mexico
    saveas(gcf,'irf_cr_mex_m6','jpg');
elseif which_country == 4   %saving for Peru
    saveas(gcf,'irf_cr_per_m6','jpg');
end
